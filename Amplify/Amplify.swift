...
public class Amplify {
    ...
    public static var testBreak1: Float = 4.0
    public func testAPIBreakage(oldVersion: Int, newVersion: Int, nextVersion: Int) -> Bool {
        return oldVersion>newVersion - nextVersion
    }
